...
test_that("summ_heartr has a valid output", {
  ...
  expect_identical(summ_heartr(heart_dat$oldpeak)$Median,
                   median(heart_dat$oldpeak))
  expect_identical(summ_heartr(heart_dat$cholesterol)$Var,
                   var(heart_dat$cholesterol))
  })
